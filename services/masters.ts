...
const masters: MasterItem[] = [
  {
    ...
    cover: 'https://images.unsplash.com/photo-1521590832167-7bcbfaa6381f?q=80&w=1200&auto=format&fit=crop',
    rating: 4.9,
    priceFrom: 45,
    availableNow: true,
    reviews: 82,
    description: 'Luxury hair extensions, keratin bonds, tape-ins and nano ring services in London.',
    lat: 51.5074,
    lng: -0.1278,
    gallery: [
  ...
  },
  {
    ...
    cover: 'https://images.unsplash.com/photo-1515377905703-c4788e51af15?q=80&w=1200&auto=format&fit=crop',
    rating: 4.7,
    priceFrom: 60,
    availableNow: false,
    reviews: 64,
  ...
  },
  {
    ...
    cover: 'https://images.unsplash.com/photo-1488426862026-3ee34a7d66df?q=80&w=1200&auto=format&fit=crop',
    rating: 4.6,
    priceFrom: 28,
    availableNow: false,
    reviews: 58,
    ...
    services: [
      ...
      },
      {
        ...
        duration: '60m',
        price: 58,
        image: 'https://images.unsplash.com/photo-1457972729786-0411a3b2b626?q=80&w=1200&auto=format&fit=crop',
      },
    ],
  },
];
