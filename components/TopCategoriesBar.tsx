...
function getSubcategoryLabel(value: string, language: AppLanguage) {
  const dict: Record<string, Partial<Record<AppLanguage, string>>> = {
    ...
    Piercing: { RU: 'Пирсинг', UA: 'Пірсинг', ES: 'Piercing', CZ: 'Piercing', DE: 'Piercing', IT: 'Piercing', FR: 'Piercing', AR: 'ثقب', PL: 'Piercing' },
    Tattoo: { RU: 'Тату', UA: 'Тату', ES: 'Tatuaje', CZ: 'Tetování', DE: 'Tattoo', IT: 'Tatuaggio', FR: 'Tatouage', AR: 'وشم', PL: 'Tatuaż' },
    'Tattoo Removal': { RU: 'Удаление тату', UA: 'Видалення тату', ES: 'Eliminación de tatuajes', CZ: 'Odstranění tetování', DE: 'Tattooentfernung', IT: 'Rimozione tatuaggio', FR: 'Détatouage', AR: 'إزالة الوشم', PL: 'Usuwanie tatuażu' },

    'Private Chef': { RU: 'Личный шеф-повар', UA: 'Особистий шеф-кухар', ES: 'Chef privado', CZ: 'Soukromý kuchař', DE: 'Privatkoch', IT: 'Chef privato', FR: 'Chef privé', AR: 'طاهٍ خاص', PL: 'Prywatny szef kuchni' },
    'Chef at Home': { RU: 'Шеф-повар на дом', UA: 'Шеф-кухар додому', ES: 'Chef a domicilio', CZ: 'Kuchař domů', DE: 'Koch zu Hause', IT: 'Chef a domicilio', FR: 'Chef à domicile', AR: 'طاهٍ في المنزل', PL: 'Szef kuchni w domu' },
    'Restaurant Table Booking': { RU: 'Бронирование столика в ресторане', UA: 'Бронювання столика в ресторані', ES: 'Reserva de mesa en restaurante', CZ: 'Rezervace stolu v restauraci', DE: 'Tischreservierung im Restaurant', IT: 'Prenotazione tavolo ristorante', FR: 'Réservation de table au restaurant', AR: 'حجز طاولة في مطعم', PL: 'Rezerwacja stolika w restauracji' },
    'Bar Table Booking': { RU: 'Бронирование столика в баре', UA: 'Бронювання столика в барі', ES: 'Reserva de mesa en bar', CZ: 'Rezervace stolu v baru', DE: 'Tischreservierung in der Bar', IT: 'Prenotazione tavolo bar', FR: 'Réservation de table au bar', AR: 'حجز طاولة في بار', PL: 'Rezerwacja stolika w barze' },
    Catering: { RU: 'Кейтеринг', UA: 'Кейтеринг', ES: 'Catering', CZ: 'Catering', DE: 'Catering', IT: 'Catering', FR: 'Traiteur', AR: 'ضيافة', PL: 'Catering' },
    'Birthday Dinner': { RU: 'Ужин на день рождения', UA: 'Вечеря на день народження', ES: 'Cena de cumpleaños', CZ: 'Narozeninová večeře', DE: 'Geburtstagsessen', IT: 'Cena di compleanno', FR: 'Dîner anniversaire', AR: 'عشاء عيد ميلاد', PL: 'Kolacja urodzinowa' },
    'Romantic Dinner': { RU: 'Романтический ужин', UA: 'Романтична вечеря', ES: 'Cena romántica', CZ: 'Romantická večeře', DE: 'Romantisches Dinner', IT: 'Cena romantica', FR: 'Dîner romantique', AR: 'عشاء رومانسي', PL: 'Romantyczna kolacja' },
    'Event Food': { RU: 'Еда для события', UA: 'Їжа для події', ES: 'Comida para evento', CZ: 'Jídlo na akci', DE: 'Event-Food', IT: 'Cibo per eventi', FR: 'Cuisine événementielle', AR: 'طعام للمناسبات', PL: 'Jedzenie na wydarzenie' },
    ...
    'Other Service': { RU: 'Другая услуга', UA: 'Інша послуга', ES: 'Otro servicio', CZ: 'Jiná služba', DE: 'Andere Dienstleistung', IT: 'Altro servizio', FR: 'Autre service', AR: 'خدمة أخرى', PL: 'Inna usługa' },
    'Custom Request': { RU: 'Индивидуальный запрос', UA: 'Індивідуальний запит', ES: 'Solicitud personalizada', CZ: 'Vlastní požadavek', DE: 'Individuelle Anfrage', IT: 'Richiesta personalizzata', FR: 'Demande personnalisée', AR: 'طلب خاص', PL: 'Indywidualne zapytanie' },
    'Not Listed': { RU: 'Нет в списке', UA: 'Немає у списку', ES: 'No está en la lista', CZ: 'Není v seznamu', DE: 'Nicht gelistet', IT: 'Non in lista', FR: 'Non listé', AR: 'غير موجود في القائمة', PL: 'Nie ma na liście' },
  };
