    ...
    >
      ...
      >
        ...
        >
          ...
          <h1 style={{ margin: '18px 0 0', fontSize: 44, fontWeight: 900 }}>
            {text.pageTitle}
          </h1>
      ...
      <div style={{ maxWidth: 430, margin: '0 auto', padding: 18 }}>
        <div
          style={{
            borderRadius: 24,
            border: `2px solid ${BRAND.black}`,
        ...
        >
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
            ...
            <span style={{ fontSize: 14, fontWeight: 900, color: BRAND.muted }}>
              {text.contactHint}
            </span>
          </div>
        </div>
